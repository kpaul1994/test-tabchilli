  ...
  customElements.define(
    ...
    class StickyAtcBar extends HTMLElement {
      ...
      init() {
        ...
        const formVisibleRatio = 0.15;
        this.observer = new IntersectionObserver(
          (entries) => {
            entries.forEach((entry) => {
              const method = entry.intersectionRatio > formVisibleRatio ? 'remove' : 'add';
      ...
      setObserveTarget = () => {
        this.observeTarget = document.querySelector('.x-main-product .x-main-product__form');
